...
public class LinkingServiceImpl implements LinkingService
{
            ...
            LinkingException
    {
        ...
        {
            throwException("get identity by provider type failed for " + identity.toString() + " and provider type "
                    + providerType.toString() + " with http error code " + response.getStatus());
    ...
    public void linkIdentities(Identity first, Identity second) throws LinkingException
    {
        ...
        {
            throwException("link identities failed for " + first.toString() + " and " + second.toString() + " with " +
    ...
    public void deleteLink(Identity identity) throws LinkingException
    {
        ...
        if (response.getStatus() != 200)
        {
            throwException("delete link failed for " + identity.toString() + " with http error code " + response
                    .getStatus());
